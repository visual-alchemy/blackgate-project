...
#
# Blackgate ISO Builder (Docker Version)
# Builds a bootable Debian 12 ISO with Blackgate Docker image pre-installed.
#
...
OUTPUT_NAME="blackgate-${VERSION}-docker-amd64"

echo "═══════════════════════════════════════════════════════════"
echo "  Blackgate Server ISO Builder v${VERSION} (Docker Edition)"
echo "═══════════════════════════════════════════════════════════"
echo ""
...
echo "🏗️  Step 3: Preparing live-build environment for Debian Bookworm..."
